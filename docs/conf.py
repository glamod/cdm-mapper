#
# cdm-mapper documentation build configuration file
#
...
extlinks = {
    "issue": ("https://github.com/glamod/cdm-mapper/issues/%s", "#%s"),
    "pull": ("https://github.com/glamod/cdm-mapper/pull/%s", "#%s"),
}
...
htmlhelp_basename = "cdm-mapperdoc"
